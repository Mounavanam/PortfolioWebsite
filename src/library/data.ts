export const projects = [
  {
    ...
    githubUrl: 'https://github.com/Mounavanam/Node.js-Chatbot-for-Real-Time-Data-Retrieval.git',
...
export const socialLinks = [
  {
    name: 'GitHub',
    url: 'https://github.com/Mounavanam',
    icon: 'Github',
  },
  /*{
    name: 'Instagram',
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/mouna-vanam-915821169/',
    icon: 'LinkedIn',
  },
  /* {
     name: 'Blog',
